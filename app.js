...
/**
 * Generate certificates for all students (PDF only)
 */
async function generateCertificates() {
  ...
  try {
    ...
    resultsSummary.textContent = `Successfully generated ${successCount} PDF certificate(s)! Downloaded as ZIP file.`;
  } catch (error) {
